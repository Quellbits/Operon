...
export default function RealAppLanding() {
  ...
  return (
    <div className="min-h-screen bg-black text-zinc-100 font-sans selection:bg-orange-500/30 selection:text-orange-200 overflow-x-hidden relative w-full">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
        ...
        {gridLabels.map((label, idx) => (
          <div
            key={`lbl-${idx}`}
            className="absolute text-[8px] font-mono text-zinc-650/80 select-none uppercase tracking-widest pointer-events-none"
      ...
      <main className="relative z-10">
            ...
            <div className="grid grid-cols-1 gap-6 relative z-10">
              ...
              <div className="space-y-2 text-left">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-[8px] font-mono text-zinc-655">INPUT_VAL = STRING</span>
                </div>
                <input 
                  type="text"
                  value={query}
                  ...
                  className="w-full bg-black border border-zinc-805 focus:border-orange-500 rounded px-4 py-3 text-xs text-zinc-200 placeholder-zinc-700 focus:outline-none transition-all font-mono"
                />
              </div>
              ...
              <div className="space-y-3 text-left">
                <div className="flex justify-between items-center">
                  <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest flex items-center gap-1.5">
                    <Database size={12} className="text-orange-450" />
                    02 / UPLOAD SPREADSHEETS
                  </label>
                  <span className="text-[8px] font-mono text-zinc-655">MAX_FILES = 5 // CSV_XLSX</span>
                </div>
                      ...
                      >
                        ...
                        <div className="mt-2 truncate">
                          {file ? (
                            ...
                            <p className="text-[9px] font-mono text-zinc-750 italic">EMPTY_SLOT</p>
                          )}
                        </div>
                      </div>
                    );
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4 border-t border-zinc-900 relative z-10">
                {files.length === 0 ? (
                  <button 
                    ...
                    className="text-[10px] text-zinc-500 hover:text-orange-400 font-mono underline transition-colors"
                  >
                    LOAD_SAMPLE_SANDBOX_TRANSACTIONS
                  </button>
                ) : (
                  <div className="text-[10px] text-zinc-550 font-mono flex items-center gap-2">
                ...
                <button 
                  ...
                  disabled={loading}
                  className="w-full sm:w-auto bg-orange-500 hover:bg-orange-600 text-black font-mono font-bold text-xs px-8 py-3.5 rounded shadow-lg shadow-orange-500/10 transition-all flex items-center justify-center gap-2 group disabled:opacity-50 cursor-pointer"
                >
                  {loading ? (
                    <>
          ...
          <div className="max-w-5xl mx-auto px-6 space-y-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
              ...
              <div className="lg:col-span-5 flex flex-col justify-between space-y-3">
                  ...
                  {stepsData.map((step, idx) => (
                    ...
                    >
                      ...
                      <div className="flex items-start gap-3">
                        <div className={`text-[10px] font-mono mt-0.5 ${activeStep === idx ? "text-orange-400" : "text-zinc-550"}`}>
                          [{idx + 1}]
                        </div>
                        <div>
                          <h4 className={`text-xs font-bold uppercase tracking-wider ${activeStep === idx ? "text-white" : "text-zinc-450"}`}>
                            {step.title}
                          </h4>
                          <span className="text-[8px] font-mono text-zinc-550 uppercase tracking-widest">{step.subtitle}</span>
                          {activeStep === idx && (
                ...
                <div className="pt-2 pl-4 flex items-center justify-between text-[10px] font-mono text-zinc-650">
                  <span>SELECT_STEP = MANUAL_OVERRIDE</span>
                  <button 
                    onClick={() => setIsPlaying(!isPlaying)}
                    className="text-orange-450 hover:underline cursor-pointer"
                  >
              ...
              <div className="lg:col-span-7 bg-zinc-950 border border-zinc-800 rounded p-6 shadow-[0_20px_50px_rgba(0,0,0,0.6)] relative h-[380px] overflow-hidden flex flex-col font-mono text-xs">
                ...
                <div className="flex items-center justify-between border-b border-zinc-800 pb-3 mb-4 shrink-0 relative z-10">
                  ...
                  <span className="text-[8px] bg-orange-500/15 text-orange-455 border border-orange-500/30 px-2 py-0.5 rounded uppercase tracking-widest font-bold">
                ...
                <div className="flex-1 overflow-y-auto space-y-4 pr-1 scrollbar-none text-left relative z-10">
                  ...
                  {activeStep === 0 && (
                    <div className="space-y-3 animate-fadeIn">
                      ...
                      <table className="w-full text-[9px] border-collapse mt-2 text-zinc-500">
                        <thead>
                          <tr className="border-b border-zinc-900 text-zinc-650 text-left">
                  ...
                  {activeStep === 2 && (
                    <div className="space-y-3 animate-fadeIn">
                      <div className="text-orange-405 flex items-center gap-2">
                        <AlertCircle size={12} />
                      ...
                      <div className="space-y-2">
                        <div className="p-2 bg-red-950/15 border border-red-900/30 rounded flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-zinc-550 text-[9px]">Vendor Acme Corp LLC represents 38.2% of regional margins in Q2.</p>
                          </div>
                        </div>
                        ...
                        <div className="p-2 bg-orange-950/15 border border-orange-900/30 rounded flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-zinc-550 text-[9px]">Region West freight rates expanded by 12.5% despite fixed pricing.</p>
                          </div>
                        </div>
                      </div>

                      <div className="flex justify-between items-center text-[9px] text-zinc-650 border-t border-zinc-900 pt-2 mt-2">
                        <span>Rows audited: 1,492 / 1,492</span>
                        <span className="text-orange-450 font-bold animate-pulse font-mono">Running metrics check...</span>
                      </div>
                    </div>
                  )}
                    ...
                    <div className="space-y-3 animate-fadeIn">
                      <div className="flex items-center gap-4 p-3 bg-zinc-950 border border-zinc-900 rounded">
                        ...
                        <div className="text-left">
                          ...
                          <p className="text-[9px] text-zinc-550">Freight Logistics exhibits cost leakage. Action required.</p>
                        </div>
                      </div>

                      <div className="bg-zinc-950/80 p-3 rounded border border-zinc-900 text-left space-y-1.5">
                        <p className="text-orange-450 font-bold tracking-wider text-[8px]">PROPOSED PLAN DRAFT</p>
                        <ul className="space-y-1 text-zinc-450 text-[9px] list-disc list-inside">
            ...
            <div className="bg-zinc-950 border border-zinc-800 rounded p-6 sm:p-8 backdrop-blur-md shadow-[0_20px_50px_rgba(0,0,0,0.5)] hover:border-zinc-700/80 transition-all duration-300 relative overflow-hidden group">
              ...
              <div className="space-y-6 text-left relative z-10">
                <div className="flex justify-between items-center pb-4 border-b border-zinc-800">
                  ...
                  <span className="text-[8px] font-mono text-emerald-450 bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20">STABLE</span>
                </div>
                ...
                <div className="pt-2">
                  <button 
                    onClick={handleUseSample}
                    className="w-full bg-zinc-900 hover:bg-zinc-800 text-zinc-300 hover:text-white font-mono text-[10px] py-3 rounded border border-zinc-800 transition-colors flex items-center justify-center gap-1.5 cursor-pointer"
                  >
        ...
        <section className="py-24 border-t border-zinc-900 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-6 text-center space-y-6 relative z-10 font-mono">
            ...
            <p className="text-zinc-550 text-xs max-w-sm mx-auto leading-relaxed normal-case font-sans">
            ...
            <div>
              <button 
                ...
                className="bg-orange-500 hover:bg-orange-600 text-black font-bold text-xs px-8 py-4 rounded shadow-xl shadow-orange-500/10 transition-all inline-flex items-center gap-2 group cursor-pointer"
              >
      ...
      <footer className="border-t border-zinc-900 bg-black py-12 relative z-10 text-[10px] font-mono text-zinc-550">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-zinc-650">© 2026 Operon Inc. All rights reserved. Smart Operations & Financial Auditing Layer.</p>
          <div className="flex items-center gap-4">
